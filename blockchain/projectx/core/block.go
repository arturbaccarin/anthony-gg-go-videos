...
type Header struct {
	...
	Nonce     uint32 // random or semi-random number that is generated for a specific use, nonce is randomly generated by the party that introduces it into the conversation
}
